    ...
    addSingleTeacherFun: function addSingleTeacherFun() {
      ...
      (0, _teacher.addSingleTeacher)(this.ruleForm).then(function (response) {
        if (response.code === 200) {
          ...
          _this5.ruleForm = { username: '', password: '', name: '' }; // 重置表单
                    ...
                    _c(
                      "el-upload",
                      {
                        ...
                        attrs: {
                          ...
                          action: "/api/teacher/addMultipleTeacher",
                          multiple: ""
                        }
                      },
                      [
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c("el-dropdown-item", { attrs: { command: "grade1" } }, [
                        _vm._v("大一管理员")
                      ]),
                      _vm._v(" "),
                      _c("el-dropdown-item", { attrs: { command: "grade2" } }, [
                        _vm._v("大二管理员")
                      ]),
                      _vm._v(" "),
                      _c("el-dropdown-item", { attrs: { command: "grade3" } }, [
                        _vm._v("大三管理员")
                      ]),
                      _vm._v(" "),
                      _c("el-dropdown-item", { attrs: { command: "grade4" } }, [
                        _vm._v("大四管理员")
                      ])
                    ],
                    1
