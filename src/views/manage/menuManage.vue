    ...
    <div class="top">
      ...
      >
        ...
        >
          ...
          <el-form-item label="路由名称" prop="routeName" v-if="this.data.type === '菜单'">
            <el-input v-model="data.routeName"></el-input>
          </el-form-item>
          <el-form-item label="路由路径" prop="routePath" v-if="this.data.type !== '功能'">
            <el-input v-model="data.routePath"></el-input>
          </el-form-item>
          <el-form-item label="组件路径" prop="componentPath"  v-if="this.data.type === '菜单'">
          ...
          <el-form-item label="路由参数" v-if="this.data.type === '菜单'">
            <el-button type="success" plain><i class="el-icon-edit"></i>添加路由参数</el-button>
          </el-form-item>
          <el-form-item label="显示状态" prop="isVisiable"  v-if="this.data.type !== '功能'">
          ...
          <el-form-item label="排序" >
            <el-input-number v-model="data.sort" controls-position="right" :min="1" :max="10"></el-input-number>
          </el-form-item>
          <el-form-item label="跳转路由" v-if="this.data.type === '目录'">
            <el-input v-model="data.jumpRoute"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="newlyBuilt"
              >确定</el-button
            >
...
export default {
  ...
  methods: {
    ...
    async newlyBuilt(row){
      ...
      if(this.isAdd){
        console.log('111');
        data = await addMenu(this.ruleForm);
      }else {
        console.log(row,'222');
        data = await editMenu(this.ruleForm);
      }
      this.tableData = data;
    },
